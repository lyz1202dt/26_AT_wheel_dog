...
Robot::Robot(const std::shared_ptr<rclcpp::Node> node)
    ...
    lf_x_vmc = std::make_shared<VMC>(160, 60, 3.0, 0.5, 1.2, 0.06, 4ms);
    lf_y_vmc = std::make_shared<VMC>(160, 60, 3.0, 0.5, 1.2, 0.06, 4ms);
    rf_x_vmc = std::make_shared<VMC>(160, 60, 3.0, 0.5, 1.2, 0.06, 4ms);
    rf_y_vmc = std::make_shared<VMC>(160, 60, 3.0, 0.5, 1.2, 0.06, 4ms);
    lb_x_vmc = std::make_shared<VMC>(160, 60, 3.0, 0.5, 1.2, 0.06, 4ms);
    lb_y_vmc = std::make_shared<VMC>(160, 60, 3.0, 0.5, 1.2, 0.06, 4ms);
    rb_x_vmc = std::make_shared<VMC>(160, 60, 3.0, 0.5, 1.2, 0.06, 4ms);
    rb_y_vmc = std::make_shared<VMC>(160, 60, 3.0, 0.5, 1.2, 0.06, 4ms);
    ...
    fsm.register_state(std::make_unique<idle_inward>(this));
       fsm.register_state(std::make_unique<idle_normal>(this));
