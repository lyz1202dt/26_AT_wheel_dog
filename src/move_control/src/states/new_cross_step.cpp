...
std::string JumpStepState::update(Robot* robot)
{
    ...
    static rclcpp::Time shift_start_time;
    ...
    else if (jump_stage == 1)
{
   ...
   computeFootForces(&F, robot, mass, mass_center_pos,
    ...
    {
        cnt = 0;
        RCLCPP_ERROR(robot->node_->get_logger(),"\003[ lf_current_pos = (%.2f, %.2f, %.2f) rf_current_pos = (%.2f, %.2f, %.2f) lb_current_pos = (%.2f, %.2f, %.2f) rb_current_pos = (%.2f, %.2f, %.2f)\033[0m", 
